...
import { Sun, Moon, Minus, Plus, Type, SunMoon, X } from 'lucide-react';
...
export function ReaderControls({ theme, setTheme, fontSize, setFontSize, onClose }: ReaderControlsProps) {
    ...
    return (
        <motion.div
            ...
            className="absolute top-0 left-0 right-0 h-16 bg-gradient-to-b from-black/20 to-transparent p-4 flex items-center justify-between gap-4 z-10"
        >
            {isMobile && (
                 <Button 
                    variant="ghost" 
