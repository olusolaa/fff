...
const blogPosts = [
    {
        ...
        content: `
            ...
            <blockquote class="pull-quote">"Grace is not opposed to effort, it is opposed to earning."</blockquote>
            ...
            <blockquote class="scripture-quote">"Don’t I have the right to do what I want with my own money? Or are you envious because I am generous?" - Matthew 20:15</blockquote>
        ...
        <div className="mt-20 bg-background text-foreground min-h-screen">
            ...
            <main>
                ...
                <article className="max-w-4xl mx-auto px-4 py-16 md:py-24">
                     <div 
                        className="prose lg:prose-lg max-w-none text-inherit prose-headings:font-headline"
