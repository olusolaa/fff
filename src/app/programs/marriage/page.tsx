...
const relatedPulpitData: Sermon[] = [
  {
    ...
    date: "May 14, 2023",
    thumbnail: "https://placehold.co/600x400/a7d1ab/1a2a1a",
    duration: 2500,
    notes: "",
    seriesId: 2,
    seriesPart: 1,
  ...
  {
    id: 14,
    title: "Freely Given, Freely Give",
    speaker: "Pastor Sarah Jones",
...
const relatedContent = [
  ...
  },
  {
    id: 2,
    type: "Article",
    title: "5 Communication Habits for a Healthier Relationship",
  ...
  },
  {
    id: 5,
    type: "Article",
    title: "The Art of Forgiveness in Marriage",
    image: "https://placehold.co/600x400",
  },
];
...
const upcomingEvents = [
  {
    ...
    date: "Nov 8-10, 2024",
    image: "/images/couples-upcoming.jpg",
  },
  {
    id: 2,
    title: "Date Night Challenge Kick-off",
    date: "Dec 5, 2024",
    image: "/images/couples-upcoming.jpg",
  },
  {
    id: 3,
    title: "Parenting & Partnership Workshop",
    date: "Jan 18, 2025",
    image: "/images/couples-upcoming.jpg",
  },
];
...
const testimonials = [
  ...
  },
  {
    ...
    story:
      "Conflict used to be something we avoided at all costs, which meant a lot of issues went unresolved. The workshops here taught us how to communicate with honesty and grace. It wasn't easy, but learning to navigate disagreements constructively has made our bond stronger than ever. We're more in love now than we were on our wedding day.",
    image: "/images/pastor.jpg",
  },
];
...
export default function MarriageMinistryPage() {
  ...
  return (
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
          <div className="md:col-span-2">
            ...
            <p className="text-lg text-foreground/80 leading-relaxed">
              We believe that marriage, as a covenant designed by God, is one of
              the most powerful reflections of His love for us. Our mission is
              to equip couples with the tools, support, and community needed to
              build strong, resilient, and joy-filled marriages that last a
              lifetime and honor God. We are here to walk with you through every
              season—the sunny days and the stormy ones—reminding you of the
              grace and hope available in Christ.
            </p>
          </div>
            ...
            <CardContent className="flex flex-col items-center text-center p-0">
              <Avatar className="w-24 h-24 mb-4">
                <AvatarImage
                  ...
                  alt="Dr. Evelyn and James Reed"
                />
                <AvatarFallback>ER</AvatarFallback>
              </Avatar>
              <h3 className="font-bold text-xl text-primary">
                Dr. Evelyn & James Reed
              </h3>
    ...
    md:grid md:grid-cols-2 md:gap-12 md:mx-0 md:px-0 md:pb-0
    scrollbar-hide
  "
          >
                    ...
                    <Card className="p-8 text-center flex flex-col items-center cursor-pointer hover:shadow-xl hover:-translate-y-2 transition-transform duration-300">
                      <CardContent className="p-0">
                        <Image
                          ...
                          data-ai-hint="happy person portrait"
                        />
            ...
            <div>
              ...
              <div className="flex overflow-x-auto space-x-4 pb-4 -mx-4 px-4 scrollbar-hide">
                {relatedPulpitData.map((item) => (
                  <div
                    key={item.id}
                    className="flex-shrink-0 w-80 md:w-1/3 lg:w-1/4"
                  >
        ...
        <section>
          ...
          <div className="flex overflow-x-auto gap-8 pb-4 -mx-4 px-4 scrollbar-hide md:grid md:grid-cols-3 md:mx-0 md:px-0">
            {upcomingEvents.map((event) => (
              <div
                key={event.id}
                className="w-80 flex-shrink-0 md:w-auto border rounded-lg overflow-hidden group"
              >
      ...
      <section className="bg-primary py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/80 mt-4 max-w-2xl mx-auto">
            Whether you're looking for guidance, community, or simply a space to
            reconnect, we're here for you.
          </p>
          <div className="mt-8">
            <Button
              size="lg"
