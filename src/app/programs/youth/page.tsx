...
const testimonials = [
    {
        ...
        story:
      "When we first joined, we were struggling to connect amidst the chaos of parenting young children. The Marriage Hub gave us practical tools, but more importantly, it gave us a community that understood. We found friends who prayed with us, laughed with us, and reminded us that we weren't alone. It's transformed not just our team, but our entire family life.",
        image: '/images/pastor.jpg'
    },
    {
        name: 'Maya',
        story:
      "Conflict used to be something we avoided at all costs, which meant a lot of issues went unresolved. The workshops here taught us how to communicate with honesty and grace. It wasn't easy, but learning to navigate disagreements constructively has made our bond stronger than ever. We're more in love now than we were on our exam day.",
